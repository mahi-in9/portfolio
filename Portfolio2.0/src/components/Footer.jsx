  ...
  return (
    <>
      ...
      <div className="fixed bottom-6 right-6 z-50">
        {isChatOpen && (
          <div className="mb-4 w-[90vw] max-w-md h-[70vh] sm:w-96 sm:h-125 bg-white/95 backdrop-blur-xl border border-gray-200 rounded-2xl shadow-2xl flex flex-col animate-in slide-in-from-bottom-4 duration-300">
            {/* Header */}
